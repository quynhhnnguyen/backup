...
public class Agent {
 ...
 /*   SimpleStringProperty agtFirstName;
    SimpleStringProperty agtMiddleInitial;
    SimpleStringProperty agtLastName;
    SimpleStringProperty agtBusPhone;
    SimpleStringProperty agtEmail;
    SimpleStringProperty agtPosition;
...
/*    public String getAgtFirstName() {
    ...
    public String toString() {
        return String.valueOf(agentId.get());
    }
}
